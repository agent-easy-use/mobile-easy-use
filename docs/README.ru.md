...
Эти наблюдения помогают агенту на всех этапах разработки:

- **Исследование и подготовка**: сопоставить реальные вызовы, данные и состояние с кодом, чтобы понять реализацию.
- **Проверка технического решения**: временно изменить настройки, поля или возвращаемые значения методов, проверить гипотезы и восстановить исходные значения.
- **Поиск проблемы**: связать вызовы, бизнес-состояние и интерфейс, чтобы найти место сбоя.
- **После изменения кода**: повторить сценарий и проверить результат. Подтверждённые ожидания можно сохранить в регрессионных тестах.
