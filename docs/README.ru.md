...
Дополните UI-действия и проверки снимков прямой проверкой внутреннего бизнес-состояния, временной подменой поведения для подготовки сценариев и анализом реальных вызовов и изменений состояния для поиска причин сбоев.
