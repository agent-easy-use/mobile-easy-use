...
Эти возможности также позволяют выполнять традиционную UI-автоматизацию. Mobile Easy Use идёт дальше: агент может не только управлять интерфейсом и проверять его, но и наблюдать и изменять то, что происходит внутри приложения.
