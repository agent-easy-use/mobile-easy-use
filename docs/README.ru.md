...
Дайте ИИ-агентам доступ к runtime приложений Android и iOS через MCP: исследовать нативные объекты и состояние, отслеживать и подменять вызовы методов, управлять интерфейсом и напрямую взаимодействовать с работающим приложением.

На записи ИИ-агент управляет работающим мобильным приложением, отслеживает реальные цепочки вызовов и исследует такие данные runtime, как время выполнения методов.
